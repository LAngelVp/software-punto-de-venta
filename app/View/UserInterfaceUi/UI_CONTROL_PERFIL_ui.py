...
# Form implementation generated from reading ui file 'c:\Users\Angel Rodriguez\LUIS_ANGEL_VALLEJO\DesktopPosWithPython\app\View\UserInterfaceUi\UI_CONTROL_PERFIL.ui'
#
...
"background:none;")
        ...
        self.gridLayout_5.addWidget(self.etiquetaTitulo_datosempleo, 1, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.etiqueta_descripcionpuesto, 7, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.etiquetaTitulo_datosusuario, 10, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.txt_puesto, 3, 1, 1, 3)
        self.txt_departamento = QtWidgets.QLineEdit(self.frame_4)
        self.txt_departamento.setObjectName("txt_departamento")
        self.gridLayout_5.addWidget(self.txt_departamento, 2, 1, 1, 3)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Icons/Bootstrap/check-square.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
