...
class Ui_contenedor_agregar_productos(object):
    def setupUi(self, contenedor_agregar_productos):
        ...
        contenedor_agregar_productos.setWindowModality(QtCore.Qt.WindowModal)
        contenedor_agregar_productos.resize(1105, 544)
        contenedor_agregar_productos.setAutoFillBackground(False)
        contenedor_agregar_productos.setStyleSheet("#etiqueta_barras{\n"
...
"}")
        ...
        self.gridLayout_14 = QtWidgets.QGridLayout(self.contenedor_general)
        self.gridLayout_14.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_14.setSpacing(0)
        self.gridLayout_14.setObjectName("gridLayout_14")
        self.contenedor_encabezado = QtWidgets.QFrame(self.contenedor_general)
        ...
        self.contenedor_scroll_formulario.setGeometry(QtCore.QRect(-222, -469, 1306, 953))
        ...
        self.contenedor_FechasCaducidades = QtWidgets.QFrame(self.contenedor_scroll_formulario)
        self.contenedor_FechasCaducidades.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.contenedor_FechasCaducidades.setFrameShadow(QtWidgets.QFrame.Raised)
        self.contenedor_FechasCaducidades.setObjectName("contenedor_FechasCaducidades")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.contenedor_FechasCaducidades)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_4.setSpacing(0)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.contenedor_contenedorFechaCaducidad = QtWidgets.QFrame(self.contenedor_FechasCaducidades)
        self.contenedor_contenedorFechaCaducidad.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.contenedor_contenedorFechaCaducidad.setFrameShadow(QtWidgets.QFrame.Raised)
        self.contenedor_contenedorFechaCaducidad.setObjectName("contenedor_contenedorFechaCaducidad")
        self.gridLayout_12 = QtWidgets.QGridLayout(self.contenedor_contenedorFechaCaducidad)
        self.gridLayout_12.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_12.setSpacing(0)
        self.gridLayout_12.setObjectName("gridLayout_12")
        self.contenedor_fechas = QtWidgets.QGridLayout()
        self.contenedor_fechas.setObjectName("contenedor_fechas")
        self.etiqueta_fechaVencimiento = QtWidgets.QLabel(self.contenedor_contenedorFechaCaducidad)
        ...
        self.fecha_vencimientoProducto = QtWidgets.QDateEdit(self.contenedor_contenedorFechaCaducidad)
        ...
        self.etiqueta_fechaFabricacion = QtWidgets.QLabel(self.contenedor_contenedorFechaCaducidad)
        self.etiqueta_fechaFabricacion.setObjectName("etiqueta_fechaFabricacion")
        self.contenedor_fechas.addWidget(self.etiqueta_fechaFabricacion, 0, 0, 1, 1)
        self.fecha_fabricacionProducto = QtWidgets.QDateEdit(self.contenedor_contenedorFechaCaducidad)
        ...
        self.contenedor_fechas.addWidget(self.fecha_fabricacionProducto, 0, 1, 1, 1)
        self.gridLayout_12.addLayout(self.contenedor_fechas, 2, 0, 1, 1)
        self.gridLayout_4.addWidget(self.contenedor_contenedorFechaCaducidad, 1, 0, 1, 1)
        self.opcion_TieneCaducidad = QtWidgets.QCheckBox(self.contenedor_FechasCaducidades)
        self.opcion_TieneCaducidad.setObjectName("opcion_TieneCaducidad")
        self.gridLayout_4.addWidget(self.opcion_TieneCaducidad, 0, 0, 1, 1)
        ...
        self.decimal_pesoProducto.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.gridLayout_5.addItem(spacerItem3, 0, 8, 1, 1)
        self.decimal_existenciaProducto = QtWidgets.QDoubleSpinBox(self.contenedor_scroll_formulario)
        self.decimal_existenciaProducto.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.decimal_costoInicialProducto.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.decimal_precioVentaProducto.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.decimal_largoDimensiones.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.decimal_altoDimensiones.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.decimal_anchoDimensiones.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.decimal_existenciaMinProducto.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.decimal_existenciaMaxProducto.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.etiqueta_margenProducto = QtWidgets.QLabel(self.contenedor_scroll_formulario)
        self.etiqueta_margenProducto.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        self.etiqueta_margenProducto.setObjectName("etiqueta_margenProducto")
        ...
        self.decimal_costoFinalProducto.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        ...
        self.entero_margenProducto = QtWidgets.QSpinBox(self.contenedor_scroll_formulario)
        self.entero_margenProducto.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.entero_margenProducto.setPrefix("")
        self.entero_margenProducto.setMaximum(100)
        self.entero_margenProducto.setObjectName("entero_margenProducto")
        ...
        self.gridLayout_13.addItem(spacerItem5, 7, 1, 1, 1)
        ...
        self.contenedor_proveedores_vinculados = QtWidgets.QFrame(self.widget)
        self.contenedor_proveedores_vinculados.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.contenedor_proveedores_vinculados.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.lista_proveedores_vinculados = QtWidgets.QListWidget(self.contenedor_proveedores_vinculados)
        self.lista_proveedores_vinculados.setObjectName("lista_proveedores_vinculados")
        self.gridLayout_8.addWidget(self.lista_proveedores_vinculados, 3, 0, 1, 1)
        self.txt_buscar_proveedor_vinculado = QtWidgets.QLineEdit(self.contenedor_proveedores_vinculados)
        self.txt_buscar_proveedor_vinculado.setClearButtonEnabled(True)
        self.txt_buscar_proveedor_vinculado.setObjectName("txt_buscar_proveedor_vinculado")
        ...
        self.contenedor_proveedores_a_vincular = QtWidgets.QFrame(self.widget)
        self.contenedor_proveedores_a_vincular.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.contenedor_proveedores_a_vincular.setFrameShadow(QtWidgets.QFrame.Raised)
        self.contenedor_proveedores_a_vincular.setObjectName("contenedor_proveedores_a_vincular")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.contenedor_proveedores_a_vincular)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.etiqueta_proveedores_a_vincular = QtWidgets.QLabel(self.contenedor_proveedores_a_vincular)
        self.etiqueta_proveedores_a_vincular.setObjectName("etiqueta_proveedores_a_vincular")
        ...
        self.contenedor_proveedores_existentes.setFrameShadow(QtWidgets.QFrame.Raised)
        self.contenedor_proveedores_existentes.setObjectName("contenedor_proveedores_existentes")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.contenedor_proveedores_existentes)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.txt_buscar_proveedor_a_vincular = QtWidgets.QLineEdit(self.contenedor_proveedores_existentes)
        self.txt_buscar_proveedor_a_vincular.setClearButtonEnabled(True)
        self.txt_buscar_proveedor_a_vincular.setObjectName("txt_buscar_proveedor_a_vincular")
        ...
        spacerItem6 = QtWidgets.QSpacerItem(20, 473, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, contenedor_agregar_productos):
        ...
        contenedor_agregar_productos.setWindowTitle(_translate("contenedor_agregar_productos", "Agregar Producto"))
        ...
        self.opcion_TieneCaducidad.setText(_translate("contenedor_agregar_productos", "¿Tiene Fecha Caducidad?"))
        ...
        self.decimal_largoDimensiones.setSuffix(_translate("contenedor_agregar_productos", "  Alto"))
        self.etiqueta_espacioDimensiones.setText(_translate("contenedor_agregar_productos", "-"))
        self.decimal_altoDimensiones.setSuffix(_translate("contenedor_agregar_productos", "  Largo"))
        self.etiqueta_espacioDimensiones_2.setText(_translate("contenedor_agregar_productos", "-"))
        self.decimal_anchoDimensiones.setSuffix(_translate("contenedor_agregar_productos", "  Ancho"))
        self.etiqueta_existenciaMaxProducto.setText(_translate("contenedor_agregar_productos", "Existencia Max."))
        self.etiqueta_margenProducto.setText(_translate("contenedor_agregar_productos", "Ganancia Margen"))
