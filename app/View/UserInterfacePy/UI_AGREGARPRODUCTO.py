...
class Ui_contenedor_agregar_productos(object):
    def setupUi(self, contenedor_agregar_productos):
        ...
        contenedor_agregar_productos.setWindowModality(Qt.WindowModal)
        contenedor_agregar_productos.resize(1105, 544)
        contenedor_agregar_productos.setAutoFillBackground(False)
        contenedor_agregar_productos.setStyleSheet(u"#etiqueta_barras{\n"
...
"}")
        ...
        self.contenedor_informacion.setFrameShape(QFrame.StyledPanel)
        self.contenedor_informacion.setFrameShadow(QFrame.Raised)
        ...
        self.contenedor_scroll_formulario.setGeometry(QRect(-219, 0, 1306, 953))
        ...
        self.contenedor_FechasCaducidades.setFrameShape(QFrame.StyledPanel)
        self.contenedor_FechasCaducidades.setFrameShadow(QFrame.Raised)
        ...
        self.contenedor_contenedorFechaCaducidad.setFrameShape(QFrame.StyledPanel)
        self.contenedor_contenedorFechaCaducidad.setFrameShadow(QFrame.Raised)
        ...
        self.fecha_vencimientoProducto.setButtonSymbols(QAbstractSpinBox.UpDownArrows)
        self.fecha_vencimientoProducto.setCorrectionMode(QAbstractSpinBox.CorrectToPreviousValue)
        ...
        self.cajaOpciones_unidadMedidaProducto.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        self.decimal_pesoProducto.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.decimal_existenciaProducto.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.decimal_costoInicialProducto.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.decimal_precioVentaProducto.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.decimal_largoDimensiones.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.decimal_altoDimensiones.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.decimal_anchoDimensiones.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.decimal_existenciaMinProducto.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.decimal_existenciaMaxProducto.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.etiqueta_margenProducto.setTextInteractionFlags(Qt.NoTextInteraction)
        ...
        self.decimal_costoFinalProducto.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.entero_margenProducto.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.contenedor_proveedores_vinculados.setFrameShape(QFrame.StyledPanel)
        self.contenedor_proveedores_vinculados.setFrameShadow(QFrame.Raised)
        ...
        self.contenedor_proveedores_a_vincular.setFrameShape(QFrame.StyledPanel)
        self.contenedor_proveedores_a_vincular.setFrameShadow(QFrame.Raised)
        ...
        self.contenedor_proveedores_existentes.setFrameShape(QFrame.StyledPanel)
        self.contenedor_proveedores_existentes.setFrameShadow(QFrame.Raised)
        ...
        self.etiqueta_listaProductos = QLabel(self.contenedor_scroll_formulario)
        self.etiqueta_listaProductos.setObjectName(u"etiqueta_listaProductos")

        self.gridLayout_13.addWidget(self.etiqueta_listaProductos, 9, 0, 1, 1)

        self.tabla_productos = QTableView(self.contenedor_scroll_formulario)
        self.tabla_productos.setObjectName(u"tabla_productos")

        self.gridLayout_13.addWidget(self.tabla_productos, 10, 0, 1, 3)
        ...
        self.contenedor_formulario_inferior.setFrameShape(QFrame.StyledPanel)
        self.contenedor_formulario_inferior.setFrameShadow(QFrame.Raised)
        ...
        self.gridLayout_7.addWidget(self.contenedor_botones, 0, 0, 1, 1, Qt.AlignLeft)
        ...
        self.gridLayout_7.addWidget(self.btn_btn_addProduct_guardar_producto, 0, 1, 1, 1, Qt.AlignRight)


        self.gridLayout_13.addWidget(self.contenedor_formulario_inferior, 11, 0, 1, 3)
        ...
        self.contenedor_formulario_derecha.setFrameShape(QFrame.StyledPanel)
        self.contenedor_formulario_derecha.setFrameShadow(QFrame.Raised)
        ...
        self.contenedor_foto.setFrameShape(QFrame.StyledPanel)
        self.contenedor_foto.setFrameShadow(QFrame.Raised)
        ...
        self.etiqueta_fotoProducto.setFrameShape(QFrame.NoFrame)
        self.etiqueta_fotoProducto.setFrameShadow(QFrame.Plain)
        self.etiqueta_fotoProducto.setTextFormat(Qt.AutoText)
        ...
        self.gridLayout_13.addWidget(self.contenedor_formulario_derecha, 0, 3, 12, 1)
    ...
    def retranslateUi(self, contenedor_agregar_productos):
        ...
        self.etiqueta_listaProductos.setText(QCoreApplication.translate("contenedor_agregar_productos", u"Lista de Productos", None))
