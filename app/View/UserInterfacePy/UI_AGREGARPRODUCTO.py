...
"}")
        ...
        self.contenedor_scroll_formulario.setGeometry(QtCore.QRect(-219, 0, 1306, 953))
        ...
        self.fecha_fabricacionProducto = QtWidgets.QDateEdit(self.contenedor_FechasCaducidades)
        ...
        self.etiqueta_fechaFabricacion = QtWidgets.QLabel(self.contenedor_FechasCaducidades)
