...
"")
        ...
        self.tabla_ordencompra = QtWidgets.QTableWidget(self.frame)
        self.tabla_ordencompra.setMinimumSize(QtCore.QSize(0, 360))
        self.tabla_ordencompra.setObjectName("tabla_ordencompra")
        self.tabla_ordencompra.setColumnCount(0)
        self.tabla_ordencompra.setRowCount(0)
