...
################################################################################
## Form generated from reading UI file 'UI_NUEVA_AREA_NEGOCIO.ui'
##
...
class Ui_Nueva_area_negocio(object):
...
"background: #68a67d;\n"
"}")
        self.gridLayout = QGridLayout(Nueva_area_negocio)
        ...
        self.retranslateUi(Nueva_area_negocio)

        QMetaObject.connectSlotsByName(Nueva_area_negocio)
    # setupUi

    def retranslateUi(self, Nueva_area_negocio):
        Nueva_area_negocio.setWindowTitle(QCoreApplication.translate("Nueva_area_negocio", u"Form", None))
        self.etiquetaTitulo_nuevacategoria.setText(QCoreApplication.translate("Nueva_area_negocio", u"Nueva \u00c1rea", None))
        self.btn_btn_guardar.setText(QCoreApplication.translate("Nueva_area_negocio", u"Guardar", None))
        self.etiqueta_nombre.setText(QCoreApplication.translate("Nueva_area_negocio", u"Nombre", None))
        self.etiqueta_descripcion.setText(QCoreApplication.translate("Nueva_area_negocio", u"Descripci\u00f3n", None))
    # retranslateUi
