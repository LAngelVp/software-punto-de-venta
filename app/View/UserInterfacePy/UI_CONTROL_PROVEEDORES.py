...
class Ui_Control_Proveedores(object):
    def setupUi(self, Control_Proveedores):
        ...
        Control_Proveedores.setStyleSheet(u"#Control_Proveedores{\n"
"background: #fffefb;\n"
"}\n"
...
"")
        ...
        self.contenedor_scroll_area_contenido.setGeometry(QRect(0, 0, 1008, 584))
        ...
        self.contenedor_todoproveedor.setFrameShape(QFrame.StyledPanel)
        self.contenedor_todoproveedor.setFrameShadow(QFrame.Raised)
        ...
        self.contenedor_datosrepresentante.setFrameShape(QFrame.StyledPanel)
        self.contenedor_datosrepresentante.setFrameShadow(QFrame.Raised)
        ...
        self.gridLayout_2.addWidget(self.etiqueta_direccionadicional, 18, 0, 1, 1, Qt.AlignTop)
        ...
        self.gridLayout_2.addWidget(self.etiqueta_descripcioncategoria, 19, 0, 1, 1, Qt.AlignTop)
        ...
        self.contenedor_tablareproveedores.setFrameShape(QFrame.StyledPanel)
        self.contenedor_tablareproveedores.setFrameShadow(QFrame.Raised)
        ...
        self.tabla_proveedores.setGridStyle(Qt.DashDotDotLine)
        ...
        self.frame = QFrame(self.contenedor_tablareproveedores)
        ...
        self.btn_btn_guardar = QToolButton(self.frame)
        ...
        self.btn_btn_guardar.setPopupMode(QToolButton.DelayedPopup)
        self.btn_btn_guardar.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.btn_btn_guardar.setAutoRaise(True)
        self.btn_btn_guardar.setArrowType(Qt.NoArrow)

        self.horizontalLayout_2.addWidget(self.btn_btn_guardar)

        self.btn_btn_actualizar = QPushButton(self.frame)
        ...
        self.btn_btn_eliminar = QToolButton(self.frame)
        ...
        self.gridLayout_7.addWidget(self.btn_btn_listadeproductoyprecios, 0, 0, 1, 1, Qt.AlignLeft)
