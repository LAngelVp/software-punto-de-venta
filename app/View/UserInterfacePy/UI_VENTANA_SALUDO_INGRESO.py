...
class Ui_Bienvenida(object):
    def setupUi(self, Bienvenida):
        ...
        Bienvenida.setStyleSheet(u"#contenedor{\n"
...
"color:rgba(0, 0, 0, 158);\n"
"}")
        self.contenedor = QFrame(Bienvenida)
        ...
        self.etiquetaBuendia.setAlignment(Qt.AlignCenter)
        ...
        self.etiquetaNombreUsuario.setAlignment(Qt.AlignCenter)
        ...
        self.etiquetaEslogan.setAlignment(Qt.AlignCenter)
    ...
    def retranslateUi(self, Bienvenida):
        ...
        self.etiquetaBuendia.setText(QCoreApplication.translate("Bienvenida", u"Excelente Ma\u00f1ana", None))
        self.etiquetaNombreUsuario.setText(QCoreApplication.translate("Bienvenida", u"Luis Angel Vallejo Perez", None))
        self.etiquetaEslogan.setText(QCoreApplication.translate("Bienvenida", u"Los grandes vendedores no venden, hacen que la gente quiera comprar.", None))
        self.btn_entrar.setText(QCoreApplication.translate("Bienvenida", u"Entrar", None))
    # retranslateUi
