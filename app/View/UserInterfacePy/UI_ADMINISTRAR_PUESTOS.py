...
"[ob"
                        "jectName*=\"tabla_\"] QHeaderView::section {\n"
...
"")
        ...
        self.frame_2 = QFrame(Formulario_puestos)
        ...
        self.contenedor_encabezado = QFrame(self.frame_2)
        ...
        self.contenedor = QFrame(self.frame_2)
        ...
        self.tabla_listapuestos = QTableView(self.frame)
        ...
        self.etiqueta_puestosexistentes = QLabel(self.frame)
        ...
        self.txt_buscarpuesto = QLineEdit(self.frame)
        ...
        self.decimal_salario.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.decimal_horaslaborales.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.tiempo_horaentrada.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.tiempo_horasalida.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.contenedor_diaslaborales.setFrameShape(QFrame.StyledPanel)
        self.contenedor_diaslaborales.setFrameShadow(QFrame.Raised)
