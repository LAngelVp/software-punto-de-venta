...
class Ui_Control_empleados(object):
    def setupUi(self, Control_empleados):
        ...
        Control_empleados.setStyleSheet(u"#Control_empleados{\n"
...
"")
        ...
        self.horizontalLayout.addWidget(self.btn_RefrescarTabla, 0, Qt.AlignVCenter)


        self.gridLayout_2.addWidget(self.contenedor_botones, 1, 0, 1, 1, Qt.AlignVCenter)
        ...
        self.tabla_listaempleados.setFrameShape(QFrame.WinPanel)
        self.tabla_listaempleados.setFrameShadow(QFrame.Plain)
        self.tabla_listaempleados.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tabla_listaempleados.setSelectionMode(QAbstractItemView.SingleSelection)
        self.tabla_listaempleados.setSelectionBehavior(QAbstractItemView.SelectRows)
        self.tabla_listaempleados.setShowGrid(True)
        self.tabla_listaempleados.setGridStyle(Qt.DashDotLine)
        ...
        self.contenedor_cabeceraopcionbusqueda.setFrameShape(QFrame.StyledPanel)
        self.contenedor_cabeceraopcionbusqueda.setFrameShadow(QFrame.Raised)
        ...
        self.gridLayout_4.addWidget(self.btn_btn_buscar, 1, 3, 1, 1, Qt.AlignVCenter)
