...
class Ui_Control_Clientes(object):
    def setupUi(self, Control_Clientes):
        ...
        Control_Clientes.setStyleSheet(u"#Control_Clientes{\n"
"background: #fffefb;\n"
"}\n"
"[objectName^=\"wpc_\"]{\n"
...
"}")
        ...
        self.wpc_scrooll_area.setGeometry(QRect(0, 0, 1384, 1090))
        ...
        self.cajaDecimal_wpc_ingresosclienteFisico.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.cajaopciones_areasnegocio_fisico.setSizeAdjustPolicy(QComboBox.AdjustToContents)
        ...
        self.contenedor_izquierda.setFrameShape(QFrame.StyledPanel)
        self.contenedor_izquierda.setFrameShadow(QFrame.Raised)
        ...
        self.label_wpc_fotocliente.setAlignment(Qt.AlignCenter)

        self.gridLayout_6.addWidget(self.label_wpc_fotocliente, 0, 0, 1, 1, Qt.AlignHCenter|Qt.AlignTop)
        ...
        self.cajaDecimal_wpc_limite_credito.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.cajaDecimal_creditodisponible_fisico.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.cajaDecimal_creditoutilizado_fisico.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.cajaDecimal_interesesaplicados_fisico.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.cajaDecimal_porcentajedescuento_fisico.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.fecha_ultimoreporte_fisico.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.wpc_contenedor_clientmoral.setFrameShape(QFrame.StyledPanel)
        self.wpc_contenedor_clientmoral.setFrameShadow(QFrame.Raised)
        ...
        self.cajaDecimal_wpc_limite_credito_moral.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.cajaDecimal_creditodisponible_moral.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.cajaDecimal_creditoutilizado_moral.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.cajaDecimal_porcentajeintereses_moral.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.cajaDecimal_porcentajedescuento_moral.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.fecha_ultimoreporte_moral.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.contenedor_opcionesclientes.setMaximumSize(QSize(400, 40))
        ...
        self.tabla_clientes.setGridStyle(Qt.DashDotLine)
        ...
        self.gridLayout_16.addWidget(self.wpc_contenedor_botones, 0, 0, 1, 1, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        self.wpc_contenedor_pila.setCurrentIndex(1)
