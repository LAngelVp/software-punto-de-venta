...
Revision ID: 792ec5ef3191
Revises: 
Create Date: 2025-03-31 12:49:42.347435
...
def upgrade() -> None:
    ...
    sa.Column('cantidad_cambio', sa.Float(), nullable=True),
    sa.Column('tipo_movimiento', sa.String(length=20), nullable=True),
