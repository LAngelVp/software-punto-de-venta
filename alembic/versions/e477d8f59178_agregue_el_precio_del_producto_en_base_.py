"""Agregue el precio del producto en base al proveedor en la tabla intermedia de productos y proveedores

Revision ID: e477d8f59178
Revises: 
Create Date: 2025-01-24 21:13:49.348880
...
def upgrade() -> None:
    ...
    sa.Column('num_telefono', sa.String(length=15), nullable=True),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('codigo_upc', sa.String(length=255), nullable=False),
    ...
    sa.Column('estado', sa.String(length=100), nullable=True),
    sa.Column('ciudad', sa.String(length=100), nullable=True),
    sa.Column('codigo_postal', sa.String(length=50), nullable=True),
    sa.Column('calles', sa.String(length=255), nullable=True),
    sa.Column('avenidas', sa.String(length=255), nullable=True),
    sa.Column('colonia', sa.String(length=255), nullable=True),
    sa.Column('direccion_adicional', sa.Text(), nullable=True),
    sa.Column('rfc', sa.String(length=255), nullable=True),
    ...
    sa.Column('contacto_emergencia', sa.String(length=20), nullable=True),
    sa.Column('parentesco_contacto', sa.String(length=30), nullable=True),
